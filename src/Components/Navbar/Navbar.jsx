...
//             <li>
//               <Link to="#" className="hover:text-pink-600 transition duration-300">Home</Link>
//             </li>
//             <li>
//               <Link to="#"  className="hover:text-pink-600 transition duration-300">About</Link>
//             </li>
//             <li>
//               <Link to="#" className="hover:text-pink-600 transition duration-300">Skills</Link>
//             </li>
//             <li>
//               <Link to="#" className="hover:text-pink-600 transition duration-300">Projects</Link>
//             </li>
//           </ul>
...
//         </div>
//       </div>
//       {toggleMenu ?  <HiXMark className='text-3xl block sm:hidden transition-all duration-300' onClick={handleToggle}/>:<HiBars3 className='text-3xl block sm:hidden transition-all duration-300' onClick={handleToggle} /> }
//       {toggleMenu && (
//             <div className="absolute top-16 left-0 bg-black text-white w-full py-4 text-center sm:hidden">
